...
extension UIView {
    ...
    @discardableResult
    open func fillView(_ view: UIView, padding: UIEdgeInsets = .zero) -> AnchoredConstraints {
        return anchor(top: view.topAnchor, leading: view.leadingAnchor, bottom: view.bottomAnchor, trailing: view.trailingAnchor, padding: padding)
    }
